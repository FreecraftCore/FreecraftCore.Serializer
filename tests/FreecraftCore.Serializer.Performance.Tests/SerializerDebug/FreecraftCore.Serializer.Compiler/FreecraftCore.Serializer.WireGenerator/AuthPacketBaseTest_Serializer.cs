...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class AuthPacketBaseTest_Serializer
            : BasePolymorphicAutoGeneratedSerializerStrategy<AuthPacketBaseTest_Serializer, AuthPacketBaseTest, Byte>
    {
