...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PatchingWelcomePayload
    {
        ...
        {
            PatchingWelcomePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            PatchingWelcomePayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingWelcomePayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<PatchingWelcomePayload_AutoGeneratedTemplateSerializerStrategy, PatchingWelcomePayload>
    {
        /// <summary>
