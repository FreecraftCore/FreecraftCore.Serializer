...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PatchingInformationPayload
    {
        ...
        {
            PatchingInformationPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            PatchingInformationPayload_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingInformationPayload_AutoGeneratedTemplateSerializerStrategy
        : BaseAutoGeneratedSerializerStrategy<PatchingInformationPayload_AutoGeneratedTemplateSerializerStrategy, PatchingInformationPayload>
    {
        /// <summary>
