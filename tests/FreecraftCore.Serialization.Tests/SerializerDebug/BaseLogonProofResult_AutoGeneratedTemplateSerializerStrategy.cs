...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class BaseLogonProofResult : IWireMessage<BaseLogonProofResult>
    {
        ...
        {
            BaseLogonProofResult_AutoGeneratedTemplateSerializerStrategy.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(BaseLogonProofResult value, Span<byte> buffer, ref int offset)
        {
            BaseLogonProofResult_AutoGeneratedTemplateSerializerStrategy.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BaseLogonProofResult_AutoGeneratedTemplateSerializerStrategy
            : BasePolymorphicAutoGeneratedSerializerStrategy<BaseLogonProofResult_AutoGeneratedTemplateSerializerStrategy, BaseLogonProofResult, Byte>
    {
