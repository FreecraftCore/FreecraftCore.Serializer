...
namespace FreecraftCore.Serializer.CustomTypes
{
	...
	public partial class ChildEnumWireContractTestType
	{
		...
		{
			ChildEnumWireContractTestType_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public override void Write(BaseEnumWireContractTestType value, Span<byte> buffer, ref int offset)
		{
			ChildEnumWireContractTestType_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class ChildEnumWireContractTestType_Serializer : BaseAutoGeneratedSerializerStrategy<ChildEnumWireContractTestType_Serializer, ChildEnumWireContractTestType>
	{
		/// <summary>
