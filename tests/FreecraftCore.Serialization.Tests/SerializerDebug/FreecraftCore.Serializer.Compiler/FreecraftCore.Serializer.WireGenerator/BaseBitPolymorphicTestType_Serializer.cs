...
namespace FreecraftCore.Serializer.CustomTypes
{
	...
	public partial class BaseBitPolymorphicTestType : IWireMessage<BaseBitPolymorphicTestType>
	{
		...
		{
			BaseBitPolymorphicTestType_Serializer.Instance.InternalRead(this, buffer, ref offset);
			return this;
		}

		public virtual void Write(BaseBitPolymorphicTestType value, Span<byte> buffer, ref int offset)
		{
			BaseBitPolymorphicTestType_Serializer.Instance.InternalWrite(this, buffer, ref offset);
		}
	}
}
...
namespace FreecraftCore.Serializer
{
	...
	/// </summary>
	public sealed partial class BaseBitPolymorphicTestType_Serializer : BasePolymorphicAutoGeneratedSerializerStrategy<BaseBitPolymorphicTestType_Serializer, BaseBitPolymorphicTestType, Byte, BitSerializerStrategy>
	{
