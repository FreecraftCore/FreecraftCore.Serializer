...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PSOBBPatchPacketPayloadClient : IWireMessage<PSOBBPatchPacketPayloadClient>
    {
        ...
        {
            PSOBBPatchPacketPayloadClient.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(PSOBBPatchPacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            PSOBBPatchPacketPayloadClient.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PSOBBPatchPacketPayloadClient
            : BasePolymorphicAutoGeneratedSerializerStrategy<PSOBBPatchPacketPayloadClient, PSOBBPatchPacketPayloadClient, UInt16>
    {
