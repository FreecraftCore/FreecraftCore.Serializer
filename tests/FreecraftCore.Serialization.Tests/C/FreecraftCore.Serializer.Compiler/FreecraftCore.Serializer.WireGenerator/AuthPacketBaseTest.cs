...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class AuthPacketBaseTest : IWireMessage<AuthPacketBaseTest>
    {
        ...
        {
            AuthPacketBaseTest.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(AuthPacketBaseTest value, Span<byte> buffer, ref int offset)
        {
            AuthPacketBaseTest.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class AuthPacketBaseTest
            : BasePolymorphicAutoGeneratedSerializerStrategy<AuthPacketBaseTest, AuthPacketBaseTest, Byte>
    {
