...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PatchingLoginRequestPayload
    {
        ...
        {
            PatchingLoginRequestPayload.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadClient value, Span<byte> buffer, ref int offset)
        {
            PatchingLoginRequestPayload.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingLoginRequestPayload
            : BaseAutoGeneratedSerializerStrategy<PatchingLoginRequestPayload, PatchingLoginRequestPayload>
    {
        /// <summary>
