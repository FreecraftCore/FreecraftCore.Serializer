...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PatchingInformationPayload
    {
        ...
        {
            PatchingInformationPayload.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            PatchingInformationPayload.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PatchingInformationPayload
            : BaseAutoGeneratedSerializerStrategy<PatchingInformationPayload, PatchingInformationPayload>
    {
        /// <summary>
