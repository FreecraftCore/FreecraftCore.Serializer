...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class PSOBBPatchPacketPayloadServer : IWireMessage<PSOBBPatchPacketPayloadServer>
    {
        ...
        {
            PSOBBPatchPacketPayloadServer.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            PSOBBPatchPacketPayloadServer.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class PSOBBPatchPacketPayloadServer
            : BasePolymorphicAutoGeneratedSerializerStrategy<PSOBBPatchPacketPayloadServer, PSOBBPatchPacketPayloadServer, UInt16>
    {
