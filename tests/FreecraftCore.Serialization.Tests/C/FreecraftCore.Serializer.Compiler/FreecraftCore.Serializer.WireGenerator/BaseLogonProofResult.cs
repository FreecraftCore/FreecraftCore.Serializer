...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class BaseLogonProofResult : IWireMessage<BaseLogonProofResult>
    {
        ...
        {
            BaseLogonProofResult.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public virtual void Write(BaseLogonProofResult value, Span<byte> buffer, ref int offset)
        {
            BaseLogonProofResult.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class BaseLogonProofResult
            : BasePolymorphicAutoGeneratedSerializerStrategy<BaseLogonProofResult, BaseLogonProofResult, Byte>
    {
