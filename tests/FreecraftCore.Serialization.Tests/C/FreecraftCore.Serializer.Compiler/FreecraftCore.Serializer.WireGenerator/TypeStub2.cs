...
namespace FreecraftCore.Serializer.CustomTypes
{
    ...
    public partial class TypeStub2
    {
        ...
        {
            TypeStub2.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseTypeStub value, Span<byte> buffer, ref int offset)
        {
            TypeStub2.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class TypeStub2
            : BaseAutoGeneratedSerializerStrategy<TypeStub2, TypeStub2>
    {
        /// <summary>
