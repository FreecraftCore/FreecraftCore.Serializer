...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class LogonProofSuccess
    {
        ...
        {
            LogonProofSuccess.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseLogonProofResult value, Span<byte> buffer, ref int offset)
        {
            LogonProofSuccess.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class LogonProofSuccess
            : BaseAutoGeneratedSerializerStrategy<LogonProofSuccess, LogonProofSuccess>
    {
        /// <summary>
