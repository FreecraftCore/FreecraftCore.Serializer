...
namespace FreecraftCore.Serializer.CustomTypes
{
    ...
    public partial class TypeStub
    {
        ...
        {
            TypeStub.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseTypeStub value, Span<byte> buffer, ref int offset)
        {
            TypeStub.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class TypeStub
            : BaseAutoGeneratedSerializerStrategy<TypeStub, TypeStub>
    {
        /// <summary>
        ...
        public override void InternalRead(TypeStub value, Span<byte> buffer, ref int offset)
        {
            ...
            value.ComplexTypeTest = NestedTypeStub.Instance.Read(buffer, ref offset);
            //Type: TypeStub Field: 12 Name: ComplexArrayTest Type: NestedTypeStub[];
            value.ComplexArrayTest = FixedSizeComplexArrayTypeSerializerStrategy<NestedTypeStub, NestedTypeStub, StaticTypedNumeric_Int32_1776>.Instance.Read(buffer, ref offset);
            ...
            value.NestedPolymorphicTypeValue = BaseTypeStub.Instance.Read(buffer, ref offset);
            ...
            value.OpenGenericTest1 = OpenGenericVector_Int32.Instance.Read(buffer, ref offset);
            //Type: TypeStub Field: 22 Name: OpenGenericTest2 Type: OpenGenericVector;
            value.OpenGenericTest2 = OpenGenericVector_Int64.Instance.Read(buffer, ref offset);
            //Type: TypeStub Field: 22 Name: OpenGenericTest3 Type: OpenGenericVector;
            value.OpenGenericTest3 = OpenGenericVector_Byte.Instance.Read(buffer, ref offset);
            //Type: TypeStub Field: 23 Name: OpenGenericArray Type: OpenGenericVector[];
            value.OpenGenericArray = ComplexArrayTypeSerializerStrategy<OpenGenericVector_Byte, OpenGenericVector<byte>>.Instance.Read(buffer, ref offset);
        ...
        public override void InternalWrite(TypeStub value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: TypeStub Field: 11 Name: ComplexTypeTest Type: NestedTypeStub;
            NestedTypeStub.Instance.Write(value.ComplexTypeTest, buffer, ref offset);
            //Type: TypeStub Field: 12 Name: ComplexArrayTest Type: NestedTypeStub[];
            FixedSizeComplexArrayTypeSerializerStrategy<NestedTypeStub, NestedTypeStub, StaticTypedNumeric_Int32_1776>.Instance.Write(value.ComplexArrayTest, buffer, ref offset);
            //Type: TypeStub Field: 13 Name: OptionalValue Type: Int32;
            ...
            //Type: TypeStub Field: 16 Name: NestedPolymorphicTypeValue Type: BaseTypeStub;
            BaseTypeStub.Instance.Write(value.NestedPolymorphicTypeValue, buffer, ref offset);
            //Type: TypeStub Field: 17 Name: BigEndianIntTestValue Type: Int32;
            ...
            //Type: TypeStub Field: 21 Name: OpenGenericTest1 Type: OpenGenericVector;
            OpenGenericVector_Int32.Instance.Write(value.OpenGenericTest1, buffer, ref offset);
            //Type: TypeStub Field: 22 Name: OpenGenericTest2 Type: OpenGenericVector;
            OpenGenericVector_Int64.Instance.Write(value.OpenGenericTest2, buffer, ref offset);
            //Type: TypeStub Field: 22 Name: OpenGenericTest3 Type: OpenGenericVector;
            OpenGenericVector_Byte.Instance.Write(value.OpenGenericTest3, buffer, ref offset);
            //Type: TypeStub Field: 23 Name: OpenGenericArray Type: OpenGenericVector[];
            ComplexArrayTypeSerializerStrategy<OpenGenericVector_Byte, OpenGenericVector<byte>>.Instance.Write(value.OpenGenericArray, buffer, ref offset);
            //Type: TypeStub Field: 24 Name: CustomTypeSerializerTestArray Type: TestCustomSerializerReferenceType[];
