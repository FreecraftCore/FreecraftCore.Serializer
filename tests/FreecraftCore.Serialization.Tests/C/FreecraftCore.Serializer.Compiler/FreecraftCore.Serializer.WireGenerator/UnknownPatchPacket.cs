...
namespace FreecraftCore.Serialization.Tests.RealWorld
{
    ...
    public partial class UnknownPatchPacket
    {
        ...
        {
            UnknownPatchPacket.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(PSOBBPatchPacketPayloadServer value, Span<byte> buffer, ref int offset)
        {
            UnknownPatchPacket.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class UnknownPatchPacket
            : BaseAutoGeneratedSerializerStrategy<UnknownPatchPacket, UnknownPatchPacket>
    {
        /// <summary>
