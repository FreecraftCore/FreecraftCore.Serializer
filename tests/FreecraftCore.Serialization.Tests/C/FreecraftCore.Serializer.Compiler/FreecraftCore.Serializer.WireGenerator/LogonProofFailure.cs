...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class LogonProofFailure
    {
        ...
        {
            LogonProofFailure.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(BaseLogonProofResult value, Span<byte> buffer, ref int offset)
        {
            LogonProofFailure.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class LogonProofFailure
            : BaseAutoGeneratedSerializerStrategy<LogonProofFailure, LogonProofFailure>
    {
        /// <summary>
