...
namespace FreecraftCore.Serializer.Tests
{
    ...
    public partial class AuthLogonProofResponse
    {
        ...
        {
            AuthLogonProofResponse.Instance.InternalRead(this, buffer, ref offset);
            return this;
        }
        public override void Write(AuthPacketBaseTest value, Span<byte> buffer, ref int offset)
        {
            AuthLogonProofResponse.Instance.InternalWrite(this, buffer, ref offset);
        }
    }
}
...
namespace FreecraftCore.Serializer
{
    ...
    /// </summary>
    public sealed partial class AuthLogonProofResponse
            : BaseAutoGeneratedSerializerStrategy<AuthLogonProofResponse, AuthLogonProofResponse>
    {
        /// <summary>
        ...
        public override void InternalRead(AuthLogonProofResponse value, Span<byte> buffer, ref int offset)
        {
            ...
            value.ProofResult = BaseLogonProofResult.Instance.Read(buffer, ref offset);
        }
        ...
        public override void InternalWrite(AuthLogonProofResponse value, Span<byte> buffer, ref int offset)
        {
            ...
            //Type: AuthLogonProofResponse Field: 1 Name: ProofResult Type: BaseLogonProofResult;
            BaseLogonProofResult.Instance.Write(value.ProofResult, buffer, ref offset);
        }
    }
}