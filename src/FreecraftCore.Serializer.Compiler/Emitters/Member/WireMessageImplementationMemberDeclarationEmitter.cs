...
namespace FreecraftCore.Serializer
{
	public sealed class WireMessageImplementationMemberDeclarationEmitter<TSerializableType> : IMemberDeclarationEmittable
	{
		...
		public MemberDeclarationSyntax Create()
		{
			...
			if (!requiresOverride && typeof(TSerializableType).BaseType != null)
			{
				if (typeof(TSerializableType).BaseType.IsWireMessageType())
					requiresOverride = true;
			}

			Type wireMessageType = requiresOverride ? GetRootWireMessageType() : typeof(TSerializableType);
		...
		private static Type GetRootWireMessageType()
		{
			Type lastType = typeof(TSerializableType).BaseType;
			Type t = typeof(TSerializableType).BaseType;
