...
namespace FreecraftCore.Serializer
{
	public sealed class RawKnownSizeStringTypeSerializerGenerator
	{
		...
		public RawKnownSizeStringTypeSerializerGenerator([NotNull] string memberName, EncodingType encoding, int fixedSizeValue, bool shouldTerminate)
		{
				...
				InvocationExpression
					(
						...
						(
							...
							IdentifierName(nameof(KnownSizeStringSerializerHelper.Write))
						)
					)
					.WithArgumentList
					(
