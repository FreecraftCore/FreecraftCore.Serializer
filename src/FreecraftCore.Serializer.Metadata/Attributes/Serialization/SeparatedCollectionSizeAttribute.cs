...
namespace FreecraftCore.Serializer
{
	...
	public sealed class SeparatedCollectionSizeAttribute : Attribute
	{
		/// <summary>
		...
		/// <inheritdoc />
		public SeparatedCollectionSizeAttribute([NotNull] string collectionPropertyName, [NotNull] string sizePropertyName)
		{
